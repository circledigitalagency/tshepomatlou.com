...
export const meta: MetaFunction = () => {
	...
	return [
		...
		{ name: "description", content: description },
		{
			name: "keywords",
			content:
				"mindfulness coach South Africa, life coach Johannesburg, leadership coaching, trauma healing, wellness retreats South Africa, Tshepo Matlou, Freedom 27, mindfulness hikes, executive coach",
		},
			...
			>
				<div className="max-w-2xl mx-auto">
					...
					<p className="text-[#3D3328]/70 leading-8 mb-10">
						Ready to begin? Reach out and let's find the right path for you.
						Whether it's one-on-one coaching, a workshop, or a retreat — your
