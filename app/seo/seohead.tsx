			...
			itemListElement: [
				{
					...
					itemOffered: {
						"@type": "Service",
						name: "Mindfulness & Wellbeing Coaching",
					},
				},
				{
					"@type": "Offer",
				...
				{
					"@type": "Offer",
					itemOffered: { "@type": "Service", name: "Trauma Healing" },
				},
				{
					"@type": "Offer",
					itemOffered: { "@type": "Service", name: "Couples Coaching" },
				},
				{
					"@type": "Offer",
					itemOffered: { "@type": "Service", name: "Team Alignment Workshops" },
				},
				{
					"@type": "Offer",
					itemOffered: { "@type": "Service", name: "Mindfulness Hikes" },
				},
				{
					"@type": "Offer",
					itemOffered: { "@type": "Service", name: "Healing Retreats" },
				},
			],
		},
	};
